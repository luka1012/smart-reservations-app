...
import smart_restaurant.administrator.model.*;
...
import static smart_restaurant.administrator.util.AdministratorConstants.*;
...
public class UserService implements UserDetailsService {
    ...
    @Log
    public List<RestaurantDao> getRestaurantsByUser(String username) throws UserNotFoundException {
