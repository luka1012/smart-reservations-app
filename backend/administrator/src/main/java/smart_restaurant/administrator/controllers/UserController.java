...
public class UserController {
    ...
    public ResponseEntity<Object> getRestaurantsByUser(@NotNull @PathVariable("username") String username) throws UserNotFoundException {

        List<RestaurantDao> allProjects = userService.getRestaurantsByUser(username);
